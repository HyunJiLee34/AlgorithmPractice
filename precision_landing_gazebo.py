    ...
    if time.time() - time_last > time_to_wait:
        ...
        try:
            if vehicle.location.global_relative_frame.alt <= 0:
                ...
                if detections['detection_scores'][0][0].numpy() >= min_score_thresh:

                    # im_width, im_height = np_data.shape[1], np_data.shape[0]
                    y_min, x_min, y_max, x_max = detections['detection_boxes'][0][0].numpy()
                    ...
                    send_local_ned_velocity(y_vel, x_vel, 0.3)
